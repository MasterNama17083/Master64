...
const Gfx coin_seg3_dl_03007800[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, coin_seg3_texture_03005780),
...
const Gfx coin_seg3_dl_03007828[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, coin_seg3_texture_03005F80),
    gsSPDisplayList(coin_seg3_dl_03007780),
    gsSPVertex(coin_seg3_vertex_030056C0, 4, 0),
    gsSPBranchList(coin_seg3_dl_030077D0),
};
...
const Gfx coin_seg3_dl_03007850[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, coin_seg3_texture_03006780),
    gsSPDisplayList(coin_seg3_dl_03007780),
    gsSPVertex(coin_seg3_vertex_030056C0, 4, 0),
    gsSPBranchList(coin_seg3_dl_030077D0),
};
...
const Gfx coin_seg3_dl_03007878[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, coin_seg3_texture_03006F80),
    gsSPDisplayList(coin_seg3_dl_03007780),
    gsSPVertex(coin_seg3_vertex_030056C0, 4, 0),
    gsSPBranchList(coin_seg3_dl_030077D0),
};
