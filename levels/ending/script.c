...
const LevelScript level_ending_entry[] = {
    ...
    /*8*/ FREE_LEVEL_POOL(),
    /*9*/ SLEEP(/*frames*/ 30), // wait delay due to black screen
    /*10*/ //BLACKOUT(/*active*/ FALSE),
    /*11*/ LOAD_AREA(/*area*/ 1),
    /*12*/ TRANSITION(/*transType*/ WARP_TRANSITION_FADE_FROM_COLOR, /*time*/ 1, /*color*/ 0x00, 0x00, 0x00),
    /*14*/ SLEEP(/*frames*/ 8), // delay wait for trigger to play sound.
