...
s16 intro_level_select(void) {
    ...
    print_text_centered(160, 90, "SELECT THE STAGE");
	print_text_centered(60, 60, "STAGE ID");
    print_text_centered(160, 30, "PRESS START BUTTON");
    print_text_fmt_int(105, 60, "%2d", gCurrLevelNum);
    print_text(138, 60, sLevelSelectStageNames[gCurrLevelNum - 1]); // print stage name
