...
void render_dl_power_meter(s16 numHealthWedges) {
    ...
    guTranslate(mtx, (f32) 260, (f32) sPowerMeterHUD.y, 0); // power meter
...
static void animate_power_meter_deemphasizing(void) {
    ...
    if (sPowerMeterHUD.y > 190) { // power meter: y 
        sPowerMeterHUD.y = 190;
...
void render_hud_mario_lives(void) {
    print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(38), 200, ","); // 'Mario Head' glyph
    print_text(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(54), 200, "*"); // 'X' glyph
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(68), 200, "%02d", gHudDisplay.lives);
}
...
void render_hud_coins(void) {
    print_text(105, 181, "+"); // 'Coin' glyph
    print_text(121, 181, "*"); // 'X' glyph
    print_text_fmt_int(135, 181, "%02d", gHudDisplay.coins);
	
	/*
	Coins HUD:
	print_text(168, HUD_TOP_Y, "+"); // 'Coin' glyph
    print_text(184, HUD_TOP_Y, "*"); // 'X' glyph
    print_text_fmt_int(198, HUD_TOP_Y, "00%d", gHudDisplay.coins);
	*/
	
	/*
	Star HUD:
	print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X), 200, "-"); // 'Star' glyph
    if (showX == 1) {
        print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X) + 16, 200, "*"); // 'X' glyph
    }
    print_text_fmt_int((showX * 14) + GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(HUD_STARS_X - 16),
                       200, "0%d", gHudDisplay.stars);
	*/
}
...
*/
    ...
    print_text(38, 181, "-"); // 'Star' glyph
    if (showX == 1) {
        print_text(54,181, "*"); // 'X' glyph
    }
    print_text_fmt_int(68,181, "%02d", gHudDisplay.stars);	
}
...
void render_hud_keys(void) {
    ...
    //for (i = 0; i < gHudDisplay.keys; i++) {
        print_text(/*(i * 16) + */105, 200, "/"); // unused glyph - beta key
		print_text(121, 200, "*"); // 'X' glyph
		print_text_fmt_int(135, 200, "%02d", gHudDisplay.keys);
		
		/*
    print_text(168, 200, "+"); // 'Coin' glyph
    print_text(184, 200, "*"); // 'X' glyph
    print_text_fmt_int(198, 200, "00%d", gHudDisplay.coins);
		*/
    //}
}
...
void render_hud_timer(void) {
    ...
    switch (eu_get_language()) {
        case LANGUAGE_ENGLISH:
            print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(150), 13, "TIME");
            break;
        case LANGUAGE_FRENCH:
            print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(155), 13, "TEMPS");
            break;
        case LANGUAGE_GERMAN:
            print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(150), 13, "ZEIT");
            break;
    }
#else
    print_text(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(150), 13, "TIME");
    ...
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(91), 13, "%02d", timerMins);
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(64), 13, "%02d", timerSecs);
    print_text_fmt_int(GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(37), 13, "%d", timerFracSecs);
...
// write this some funny huds
void render_printmsg_hud(void) {
	 // print_string_generic
	 print_text(20, 60, "MASTER64 DEBUG BUILD");
	 print_text(20, 40, "BUILD RELEASE");
	 print_text(20, 20, "FOR DEBUGGING PURPOSES");	 
}
