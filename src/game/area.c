...
#else       // EARLY but unused:    
            //print_text_centered(120, 38, "PRESS");
            //print_text_centered(190, 38, "START");
			// end
			//print_text_centered(160, 30, "PRESS START BUTTON");
#endif
        }
    }
	print_text(15, 200, "V1#0 RELEASE BUILD");
	//print_text(20, 200, "04 DEVKIT DRAFT PENDING");
	//print_text(130,100, "V0.4");
	
	// EASTER EGG (JOKE BUILD 0.3 PRE-ALPHA:
	/*print_text(90,130, "FATAL ERROR");
	print_text(20,100, "79 6F 75 20 64 69 64 20");
	print_text(20,80, "74 68 69 73 20 61 6E 64");
	print_text(90,60, "20 6F 70 65");*/
	//print_text_centered(159, 150, "ULTRA 64 MARIO BROTHERS"); // unused text (not a placeholder!!!)
	print_text_centered(160, 30, "PRESS START BUTTON");
}
